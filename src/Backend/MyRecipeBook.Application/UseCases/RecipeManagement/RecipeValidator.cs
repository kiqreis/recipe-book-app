...
namespace MyRecipeBook.Application.UseCases.RecipeManagement;
...
public class RecipeValidator : AbstractValidator<RecipeRequest>
{
    public RecipeValidator()
    {
        ...
        RuleForEach(recipe => recipe.Instructions).ChildRules(instructionRule =>
        {
            ...
            instructionRule.RuleFor(instruction => instruction.Text).NotEmpty().WithMessage(ResourceMessagesException.INSTRUCTION_EMPTY)
          .MaximumLength(255)
